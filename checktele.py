...
•- 𝐭𝐚𝐲𝐩 •- 𝙲𝙷𝙰𝙽𝙽𝙴𝙻
•- 𝐜𝐡  •- @o_z_g ''')
                    await event.client.send_message("@Flmod_1500_Bot", f''' ⌲  '•- 𝐧𝐞𝐰 𝐮𝐬𝐞𝐫 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦
•- 𝐮𝐬𝐞𝐫 •- @{username}
•- 𝐭𝐚𝐲𝐩 •- 𝙲𝙷𝙰𝙽𝙽𝙴𝙻
•- 𝐜𝐡  •- @o_z_g ''')
                    break
                    ...
                    try:
                    	...
                    	await sython.send_message("Flmod_1500_Bot",f"ֆ ɴᴇᴡ ᴜsᴇʀɴᴀᴍᴇ ғʟᴏᴏᴅ ⚚ \n\n↬ ᴜsᴇʀɴᴀᴍᴇ : @{username}\n\n sᴇɴᴅ : `/us @{username}`")
